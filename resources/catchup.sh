...
setLabFile(){
    ...
    local lab_file="${LABS_PATH}/repository_lab0.py"
    if [ $1 -eq 1 ]
    then
        lab_file="${LABS_PATH}/repository_lab1.py"
    elif [ $1 -eq 2 ]
    then
        lab_file="${LABS_PATH}/repository_lab2.py"
    elif [ $1 -eq 3 ]
    then
        lab_file="${LABS_PATH}/repository_lab3.py"
    elif [ $1 -eq 4 ]
    then
        lab_file="${LABS_PATH}/repository_lab4.py"
    elif [ $1 -eq 5 ]
    then
        lab_file="${LABS_PATH}/repository_lab5.py"
    else
        lab_file="${LABS_PATH}/repository_final.py"
    fi
